...
class LocalMusicSource(
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        musicList.add(
                            MusicModel(
                                ...
                                artists =
                                    artistCache.getOrPut(artistString ?: "") {
            ...
            context.contentResolver
                .query(
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        val artists =
                            artistCache.getOrPut(rawArtist ?: "") {
    ...
    override suspend fun getFolderList(): List<FolderModel> =
        withContext(Dispatchers.IO) {
    ...
    override suspend fun getPlaylistList(): List<PlaylistModel> =
        withContext(Dispatchers.IO) {
    ...
    @Suppress("DEPRECATION")
    override suspend fun getSongsByPlaylist(playlistId: String): List<MusicModel> =
        withContext(Dispatchers.IO) {
            val musicList = mutableListOf<MusicModel>()
            val artistCache = mutableMapOf<String, List<String>>()
            val uri =
                MediaStore.Audio.Playlists.Members
                    .getContentUri("external", playlistId.toLong())
    ...
    private suspend fun getMusicListWithSelection(
        selection: String,
